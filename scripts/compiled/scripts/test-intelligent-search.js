...
const multi_collection_models_1 = require("../lib/database/multi-collection-models");
...
async function runIntelligentSearchTests() {
    try {
        ...
        const dbModels = new multi_collection_models_1.MultiCollectionDatabaseModels();
        // 获取系统状态
        console.log('📊 获取系统状态...');
        ...
        for (let i = 0; i < testCases.length; i++) {
            ...
            try {
                const searchResult = await dbModels.intelligentSearch(testCase.query, testCase.articleDomain, testCase.limit);
                ...
                if (searchResult.success) {
                    ...
                    testResults.push({
                        ...
                        domainDistribution: searchResult.results.reduce((acc, result) => {
