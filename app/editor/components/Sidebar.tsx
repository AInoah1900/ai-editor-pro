...
export default function Sidebar({ activeMenu, setActiveMenu, setActiveSubMenu }: SidebarProps) {
  ...
  return (
    <div className="w-16 bg-white border-r border-gray-200 flex flex-col items-center py-4 space-y-4">
      ...
      {/* DeepSeek API配置 */}
      <Link href="/deepseek-config" target="_blank">
        <button className="w-12 h-12 rounded-xl flex items-center justify-center text-gray-500 hover:text-blue-600 hover:bg-blue-50 transition-all duration-300 group relative border border-transparent hover:border-blue-200">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
